            ...
            <div class="modal-body">
                <form action="<?= BASEURL ?>/kost/addKost" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_kost" name="nama_kost"
                            placeholder="Masukan nama kost" autocomplete="off">
                    </div>
                    <div class="mb-3">
                ...
                placeholder="Masukan stok customer" autocomplete="off"> -->
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="kategori_kost"
                            id="kategori_kost">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="alamat_kost" id="alamat_kost"
                            placeholder="Masukan alamat kost" cols="30" rows="5" autocomplete="off"></textarea>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-body">
                <form action="<?= BASEURL ?>/kost/addKamarKost" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="numeric" class="form-control" id="no_kamar" name="no_kamar"
                            placeholder="Masukan nomor kamar" autocomplete="off">
                    </div>
                    <div class="mb-3">
...
<div class="page-content">
    ...
    <button type="button" class="btn btn-info btnTambahKamar me-2" data-bs-toggle="modal" data-bs-target="#tampilModalUbahKamarKost">
            ...
            <table
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                        ...
                        <td class="aksi">
                            <a href="<?= BASEURL ?>/kost/showKamarKost/<?= $kost['id_kost'] ?>" data-bs-toggle="modal"
                                data-bs-target="#carouselModal"><button class=" btn btn-outline-success me-2"><i
                                        class="bi bi-image"></i></button></a>
                            <a href="<?= BASEURL; ?>/kost/editKamarKost/<?= $kost['id_kamar'] ?>"
                                class="tampilModalUbahKamarKost" data-id="<?= $kost['id_kamar'] ?>" data-bs-toggle="modal"
                                data-bs-target="#tampilModalUbahKamarKost"><button
                                    class="btn btn-outline-primary me-2"><i class=" bi bi-pencil-fill"></i></button></a>
                            <a href="<?= BASEURL ?>/kost/deleteKamarKost/<?= $kost['id_kamar']?>"
                                onclick="return confirm('Yakin hapus data?');"><button
                                    class=" btn btn-outline-danger"><i class="bi bi-trash-fill"></i></button></a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
