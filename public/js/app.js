        ...
        e.exports = (function () {
          ...
          function m(e) {
            ...
            (e.containerWidth = n(r.width)),
              ...
              !e.settings.suppressScrollX && e.containerWidth + e.settings.scrollXMarginOffset < e.contentWidth ? ((e.scrollbarXActive = !0), (e.railXWidth = e.containerWidth - e.railXMarginWidth), (e.railXRatio = e.containerWidth / e.railXWidth), (e.scrollbarXWidth = g(e, y((e.railXWidth * e.containerWidth) / e.contentWidth))), (e.scrollbarXLeft = y(((e.negativeScrollAdjustment + i.scrollLeft) * (e.railXWidth - e.scrollbarXWidth)) / (e.contentWidth - e.containerWidth)))) : (e.scrollbarXActive = !1),
              !e.settings.suppressScrollY && e.containerHeight + e.settings.scrollYMarginOffset < e.contentHeight ? ((e.scrollbarYActive = !0), (e.railYHeight = e.containerHeight - e.railYMarginHeight), (e.railYRatio = e.containerHeight / e.railYHeight), (e.scrollbarYHeight = g(e, y((e.railYHeight * e.containerHeight) / e.contentHeight))), (e.scrollbarYTop = y((o * (e.railYHeight - e.scrollbarYHeight)) / (e.contentHeight - e.containerHeight)))) : (e.scrollbarYActive = !1),
          ...
          function v(e, n) {
            ...
            n.isScrollbarYUsingRight ? (n.isRtl ? (l.right = n.contentWidth - (n.negativeScrollAdjustment + e.scrollLeft) - n.scrollbarYRight - n.scrollbarYOuterWidth - 9) : (l.right = n.scrollbarYRight - e.scrollLeft)) : n.isRtl ? (l.left = n.negativeScrollAdjustment + e.scrollLeft + 2 * n.containerWidth - n.contentWidth - n.scrollbarYLeft - n.scrollbarYOuterWidth) : (l.left = n.scrollbarYLeft + e.scrollLeft), i(n.scrollbarYRail, l), i(n.scrollbarX, { left: n.scrollbarXLeft, width: n.scrollbarXWidth - n.railBorderXWidth }), i(n.scrollbarY, { top: n.scrollbarYTop, height: n.scrollbarYHeight - n.railBorderYWidth });
          }
          function j(e, t) {
            function n(t) {
          ...
          var L = { isWebKit: "undefined" != typeof document && "WebkitAppearance" in document.documentElement.style, supportsTouch: "undefined" != typeof window && ("ontouchstart" in window || ("maxTouchPoints" in window.navigator && 0 < window.navigator.maxTouchPoints) || (window.DocumentTouch && document instanceof window.DocumentTouch)), supportsIePointer: "undefined" != typeof navigator && navigator.msMaxTouchPoints, isChrome: "undefined" != typeof navigator && /Chrome/i.test(navigator && navigator.userAgent) },
                ...
                function d() {
                  i.settings.swipeEasing &&
                    ...
                    (x = setInterval(function () {
                      return i.isInitialized ? void clearInterval(x) : f.x || f.y ? (0.01 > e(f.x) && 0.01 > e(f.y) ? void clearInterval(x) : i.element ? (r(30 * f.x, 30 * f.y), (f.x *= 0.8), void (f.y *= 0.8)) : void clearInterval(x)) : void clearInterval(x);
                    }, 10)));
                }
            ...
            z = function (e, r) {
              ...
              (this.scrollbarYRight = parseInt(d.right, 10)),
                ...
                (this.reach = { x: 0 >= e.scrollLeft ? "start" : e.scrollLeft >= this.contentWidth - this.containerWidth ? "end" : null, y: 0 >= e.scrollTop ? "start" : e.scrollTop >= this.contentHeight - this.containerHeight ? "end" : null }),
                (this.isAlive = !0),
